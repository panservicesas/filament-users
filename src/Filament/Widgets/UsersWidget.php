...
class UsersWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $widgets[] = BaseWidget\Stat::make(__('filament-users::filament-users.widget.users'),
            Cache::tags($tag)
        ...
        if (Utils::isFilamentShieldInstalled()) {
            $widgets[] = BaseWidget\Stat::make(__('filament-users::filament-users.resource.roles'),
                Cache::tags($tag)
            ...
            $widgets[] = BaseWidget\Stat::make(__('filament-users::filament-users.resource.permissions'),
                Cache::tags($tag)
